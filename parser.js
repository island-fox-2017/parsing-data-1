...
class PersonParser {
  ...
  addPerson(data) {
    fs.appendFile('tes.csv', data, function (err) {
    if (err) throw err;
    console.log('Saved!');
  });
  ...
  readcsv() {
    this.readFile('tes.csv', fileContent => {
...
let parser = new PersonParser('tes.csv')
parser.addPerson('201,Achim,Baggins,achim_baggins@yahoo.com,8-180-370-43434,2013-12-02T06:45:30-08:00\n');
parser.readcsv();
