...
class PersonParser {
  ...
  addPerson() {
    ...
    var satuTmp = `${satu.id},${satu.FirstName},${satu.LastName},${satu.email},${satu.phone},${satu.created}\n`
    var tambahin = satuTmp
    fs.appendFile('people.csv', tambahin, (err) => {
      if (err) throw err;
